...
ENV VIRTUAL_CAMERA_USER_IMAGE_URL=https://i.ibb.co/N9YtnDZ/ducobu.jpg
ENV VIRTUAL_CAMERA_SHOW_USER_IMAGE=true
ENV VIRTUAL_CAMERA_IMAGE_POSITION=corner
ENV VIRTUAL_CAMERA_IMAGE_OPACITY=0.8
