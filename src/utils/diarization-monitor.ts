 ...
 */
export class DiarizationMonitor {
  /**
   ...
   */
  public static async checkDiarizationHealth(
   ...
   */
  public static logHealthStatus(status: DiarizationHealthStatus): void {
    if (status.status === "optimal") {
      console.log(
        `[DiarizationHealth] ✅ Optimal: ${status.segmentCount60s} segments in last 60s`
      )
      ...
      console.log(
        `[DiarizationHealth] ❌ Stale: No segments in last 5min despite sound activity`
      )
    }
  }
}
