...
export class MeetingStateMachine {
  ...
  public getError(): Error | null {
    return GLOBAL.hasError() ? new Error(GLOBAL.getErrorMessage() || "Unknown error") : null
  }
  ...
  public async startRecordMeeting(): Promise<void> {
    try {
      ...
      if (this.getError() || this.currentState === MeetingStateType.Error) {
